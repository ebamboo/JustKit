...
public class Stepper: UIView {
    ...
    /// 点击 valueLabel 事件
    /// 例如：在获取该事件然后弹出其他自定义视图来修改 value 功能；
    var onClickValue: ((_ value: Int) -> Void)?
    ...
    private lazy var valueLabel: UILabel = {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(didTapValueAction))
...
public extension Stepper {
    ...
    @objc private func didTapValueAction() {
        onClickValue?(value)
    }
